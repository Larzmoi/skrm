    ...
    for (const order of shipped) {
        if (order.deliveryConfirmedAt) {
            ...
            if (confirmedAge >= DAY_MS) {
                ...
                await (0, notify_1.notifyUser)(order.sellerId, 'PAYMENT_RELEASED', 'Maksu vapautettu', 'Ostaja kuittasi vastaanoton eikä reklamoinut 24 tunnin kuluessa — maksu on vapautettu sinulle.', '/dashboard/tilaukset');
