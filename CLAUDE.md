...
**30. Puuttuu "Jaa striimi" -nappi.** Toivottu lisäys: nappi jolla voi jakaa käynnissä olevan (tai tulevan) lähetyksen linkin — esim. kopioi linkki leikepöydälle, tai natiivi jako-valikko (Web Share API mobiilissa). Sijoitus todennäköisesti live-konsolin yläpalkkiin (myyjän puolella) ja/tai katsojan `/live/[showId]`-sivulle, jotta katsojatkin voivat jakaa striimin eteenpäin.
