...
**⬜ TEKEMÄTTÄ ennen oikeaa tuotantokäyttöä:** Stripen tuotantotunnukset (`sk_live_...`/`pk_live_...`/`STRIPE_WEBHOOK_SECRET`) testitunnusten (`sk_test_...`/`pk_test_...`) sijaan — vain `.env`-arvojen vaihto, ei koodimuutosta, sama periaate kuin Paytrailin testi→tuotanto-siirtymässä olisi ollut.
