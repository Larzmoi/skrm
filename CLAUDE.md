...
**⏳ SEURAAVAKSI, EI VIELÄ ALOITETTU — suurin jäljellä oleva sivu:** `/lahetys` (koko live-striimauskonsoli myyjälle) — omistaja listasi laajasti kovakoodattuja tekstejä (OBS-asetukset, "Ilman OBS:aa"/"OBS:lla", kameran esikatselu, lähetyksen luontilomake, tyhjä jono -tila, jne.). Ei koskettu vielä.
