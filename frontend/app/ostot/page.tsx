                    ...
                    return (
                      <div key={order.id} style={{ background: C.cardBg, border: `1px solid ${C.border}`, borderRadius: 12, padding: '16px 20px' }}>
                        ...
                        {section.key === 'PENDING_PAYMENT' && order.shippingPrice == null && (
                          <div style={{ marginTop: 12, paddingTop: 12, borderTop: `1px solid ${C.border}` }}>
                            {/* Todellinen 12h maksuaika (2h -> 12h 2026-09-11, ks. CLAUDE.md) juoksee
                                taustalla vaikka toimitustapaa ei ole vielä valittu - ilman tätä
                                ostaja näki vain 6h toimitusvalinta-ikkunan eikä koskaan oikeaa
                                maksudeadlinea ennen kuin valitsi toimitustavan (ks. CLAUDE.md
                                "Uudet löydökset 2026-08-13" kohta 13). */}
