...
const FAQ_DATA = {
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Kuinka kauan minulla on aikaa maksaa?', a: 'Voitetusta live-huudosta, "Osta heti" -ostoksesta tai hyväksytystä tarjouksesta on 12 tuntia aikaa maksaa. Poikkeus: jos voitat perinteisen (ajastetun) huutokaupan joka päättyy itsestään ilman että olet juuri sillä hetkellä paikalla, saat 24 tuntia aikaa — koska et välttämättä huomaa voittoa heti. Jos maksuaika ehtii loppua, tilisi estetään automaattisesti 30 päiväksi.' },
        { q: 'Miten maksan ostokseni?', a: 'Maksu tapahtuu Stripen kautta — tuetaan korttimaksuja sekä lompakkoja kuten Apple Pay, Google Pay ja MobilePay.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Mikä on välityspalkkio?', a: 'Habahub perii myyjältä 3,5% välityspalkkion myyntihinnasta, vähintään 0,30€ ja enintään 35€ per kauppa. Ostajalta veloitetaan checkoutissa lisäksi erillinen maksunkäsittelymaksu (n. 1,5% + 0,25€ koko tilauksen summasta) — tämä ei vähennä myyjän saamaa osuutta.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Yhdistyvätkö ostokseni samalta myyjältä yhdeksi paketiksi?', a: 'Kyllä, automaattisesti — ei tarvitse olla yhteydessä myyjään. Jos voitat tai ostat useamman tuotteen samalta myyjältä 24 tunnin sisällä etkä ole vielä maksanut ensimmäistä ostosta, ne yhdistyvät samaksi tilaukseksi ja maksat postikulut vain kertaalleen. Kun maksat tilauksen, yhdistäminen lukkiutuu siihen mennessä kertyneisiin tuotteisiin — sen jälkeen tehty ostos samalta myyjältä muodostaa oman, erillisen tilauksensa omine postikuluineen.' },
      ],
    },
  ],
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'How long do I have to pay?', a: 'You have 12 hours to pay after winning a live bid, a "Buy Now" purchase, or an accepted offer. Exception: if you win a traditional (scheduled) auction that ends on its own while you are not actively present, you get 24 hours instead - since you might not notice the win right away. If the payment window runs out, your account is automatically suspended for 30 days.' },
        { q: 'How do I pay?', a: 'Payment is made through Stripe — supporting card payments as well as wallets such as Apple Pay, Google Pay and MobilePay.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What is the commission?', a: 'Habahub charges the seller a 3.5% commission on the sale price, with a minimum of €0.30 and a maximum of €35 per sale. The buyer is also charged a separate payment processing fee at checkout (~1.5% + €0.25 of the full order amount) — this does not reduce the seller\'s share.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Do my purchases from the same seller get combined into one package?', a: "Yes, automatically — no need to contact the seller. If you win or buy multiple items from the same seller within 24 hours and haven't paid for the first purchase yet, they're combined into one order and you only pay shipping once. Once you pay the order, the combining locks in place for the items included so far — a purchase from the same seller after that starts its own separate order with its own shipping fee." },
      ],
    },
  ],
  sv: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Hur länge har jag på mig att betala?', a: 'Du har 12 timmar på dig att betala efter att ha vunnit ett livebud, ett "Köp nu"-köp eller ett accepterat bud. Undantag: om du vinner en traditionell (schemalagd) auktion som avslutas av sig själv utan att du är närvarande just då, får du 24 timmar istället — eftersom du kanske inte märker vinsten direkt. Om betalningstiden går ut spärras ditt konto automatiskt i 30 dagar.' },
        { q: 'Hur betalar jag?', a: 'Betalning sker via Stripe — stöder kortbetalningar samt digitala plånböcker som Apple Pay, Google Pay och MobilePay.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Vad är förmedlingsavgiften?', a: 'Habahub tar ut en förmedlingsavgift av säljaren på 3,5% av försäljningspriset, minst 0,30€ och högst 35€ per affär. Köparen debiteras dessutom en separat betalningshanteringsavgift i kassan (ca 1,5% + 0,25€ av hela ordersumman) — detta minskar inte säljarens andel.' },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Slås mina köp från samma säljare samman till ett paket?', a: 'Ja, automatiskt — du behöver inte kontakta säljaren. Om du vinner eller köper flera produkter från samma säljare inom 24 timmar och ännu inte har betalat för det första köpet, slås de samman till en beställning och du betalar frakten bara en gång. När du betalar beställningen låses sammanslagningen för de produkter som hunnit inkluderas då — ett köp från samma säljare efter det bildar en egen, separat beställning med egen fraktavgift.' },
      ],
    },
  ],
}
