...
const FAQ_DATA = {
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Mikä on välityspalkkio?', a: 'Habahub perii 3,5% välityspalkkion myyntihinnasta, vähintään 0,30€ ja enintään 35€ per kauppa. Lisäksi peritään maksunkäsittelykulut (n. 1,5% + 0,25€).' },
  ...
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What is the commission?', a: 'Habahub charges a 3.5% commission on the sale price, with a minimum of €0.30 and a maximum of €35 per sale. Payment processing fees also apply (~1.5% + €0.25).' },
  ...
  sv: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Vad är förmedlingsavgiften?', a: 'Habahub tar ut en förmedlingsavgift på 3,5% av försäljningspriset, minst 0,30€ och högst 35€ per affär. Dessutom tillkommer betalningshanteringsavgifter (ca 1,5% + 0,25€).' },
