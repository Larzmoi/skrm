      ...
      <div style={{ flexShrink: 0 }}>
        {showPresetPicker ? (
          ...
          <div style={{ marginTop: 10, borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: 10 }}>
            ...
            <input value={qaName} onChange={e => { setQaName(e.target.value); setQaPresetId(null) }} placeholder={sc.productNamePlaceholder} spellCheck={false} autoCorrect="off" autoCapitalize="off" style={{ width: '100%', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 6, padding: '7px 9px', color: '#fff', fontSize: 12, outline: 'none', boxSizing: 'border-box', marginBottom: 6 }} />
