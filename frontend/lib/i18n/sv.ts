const sv = {
  ...
  auth: {
    ...
    policyPoint4: 'Kombinerad leverans: samma säljare inom 24h = ett val av fraktmetod',
  ...
  profile: {
    ...
    selling: 'Till salu',
    liveSelling: 'Tillgänglig i livesändning', liveNowBadge: 'LIVE NU', liveSoonBadge: 'Kommande',
  ...
  purchases: {
    ...
    shippingMethodLabel: 'Leveranssätt', shippingMethodPostitus: 'Frakt', shippingMethodNouto: 'Avhämtning hos säljaren',
    waitingPickup: 'Betald — väntar på hämtning',
    mergedOrderNote: 'Denna order slår samman {n} köp från samma säljare — frakten debiteras bara en gång.',
  ...
  salesPage: {
    ...
    shippingMethodLabel: 'Leveranssätt', shippingMethodPostitus: 'Frakt', shippingMethodNouto: 'Avhämtning hos säljaren',
    mergedOrderNote: 'Denna order slår samman {n} köp — köparen debiterades frakt bara en gång.',
  ...
  streamConsole: {
    ...
    scheduledShowFoundTitle: 'Du har redan en schemalagd sändning',
    scheduledShowFoundHint: 'Välj om du vill fortsätta den, eller starta en annan, spontan sändning nu — den schemalagda sändningen förblir orörd och väntar fortfarande på sin egen tid om du väljer det senare.',
    resumeScheduledChoiceBtn: 'Fortsätt den schemalagda',
    startDifferentShowBtn: 'Starta en annan sändning nu',
