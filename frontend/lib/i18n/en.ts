const en = {
  ...
  home: {
    ...
    heroTrustCommission: '3% fee, max €35', heroTrustFreeSignup: 'Free to sign up',
    heroHide: 'Hide',
  },
  live: {
  ...
  dashboardProducts: {
    ...
    pickupBody: 'When a buyer purchases the item through SKRM and chooses pickup as the delivery method, the sale is normally covered by payment protection. The buyer receives a pickup code, which you enter into the system when you hand over the item — the payment is released to you as soon as the code is confirmed. This does not apply to arrangements made entirely outside SKRM (e.g. a cash sale agreed directly, with no SKRM order) — SKRM is not a party to those and does not offer payment protection.',
  ...
  footer: {
    ...
    feeNote: 'Commission 3% (max €35) + payment processing ~1.5% + €0.25',
  ...
  about: {
    ...
    description2: 'Our mission is to build the best and most affordable marketplace in Finland. We offer sellers a low commission — just 3% max €35 per sale.',
