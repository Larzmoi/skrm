const en = {
  ...
  auth: {
    ...
    policyPoint4: 'Combined shipment: same seller within 24h = one shipping choice',
  ...
  profile: {
    ...
    selling: 'For sale',
    liveSelling: 'Available in live stream', liveNowBadge: 'LIVE NOW', liveSoonBadge: 'Upcoming',
  ...
  purchases: {
    ...
    shippingMethodLabel: 'Delivery method', shippingMethodPostitus: 'Shipping', shippingMethodNouto: 'Pickup from seller',
    waitingPickup: 'Paid — awaiting pickup',
    mergedOrderNote: 'This order combines {n} purchases from the same seller — shipping is only charged once.',
  ...
  salesPage: {
    ...
    shippingMethodLabel: 'Delivery method', shippingMethodPostitus: 'Shipping', shippingMethodNouto: 'Pickup from seller',
    mergedOrderNote: 'This order combines {n} purchases — the buyer was only charged shipping once.',
  ...
  streamConsole: {
    ...
    scheduledShowFoundTitle: 'You already have a scheduled stream',
    scheduledShowFoundHint: 'Choose whether to continue it, or start a different, spontaneous stream now — the scheduled stream stays untouched and still waits for its own time if you pick the latter.',
    resumeScheduledChoiceBtn: 'Continue the scheduled one',
    startDifferentShowBtn: 'Start a different stream now',
