const fi = {
  ...
  about: {
    ...
    description2: 'Missiomme on rakentaa Suomen paras ja edullisin marketplace. Tarjoamme myyjille alhaisen provision — vain 3% max 20€ per kauppa.',
    ...
    cheapest: 'Halvin provisio', cheapestSub: 'Max 20€ per kauppa',
