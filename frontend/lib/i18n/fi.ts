const fi = {
  ...
  home: {
    ...
    heroTrustCommission: '3% provisio, max 35€', heroTrustFreeSignup: 'Ilmainen rekisteröityminen',
    heroHide: 'Piilota',
  },
  live: {
  ...
  dashboardProducts: {
    ...
    pickupBody: 'Kun ostaja ostaa tuotteen SKRM:n kautta ja valitsee toimitustavaksi noudon, kauppa kuuluu normaalisti maksuturvan piiriin. Ostaja saa noutokoodin, jonka syötät järjestelmään kun luovutat tuotteen — maksu vapautuu sinulle heti kun koodi on vahvistettu. Tämä ei koske sopimuksia jotka sovitaan kokonaan SKRM:n ulkopuolella (esim. suoraan sovittu käteiskauppa ilman SKRM-tilausta) — niissä SKRM ei ole osapuoli eikä tarjoa maksuturvaa.',
  ...
  footer: {
    ...
    feeNote: 'Välityspalkkio 3% (max 35€) + maksunkäsittely ~1,5% + 0,25€',
  ...
  fees: {
    ...
    protectionDesc: 'Ostajan maksu pidätetään SKRM:n tilillä kunnes myyjä on lähettänyt tuotteen ja toimittanut seurantakoodin.',
    protectionPoints: [
      'Maksu vapautetaan myyjälle kun seurantakoodi on toimitettu',
      'Ostajalla 3 päivää reklamoida vastaanoton jälkeen',
      'Riitatilanteet selvitetään SKRM:n asiakastuessa',
    ],
    noFees: [
  ...
  about: {
    ...
    description1: 'SKRM on suomalainen alusta live-huutokaupalle ja suoramyynnille. Myyjät voivat myydä tuotteitaan reaaliaikaisessa videolähetyksessä tai listata ne suoraan myyntiin.',
    description2: 'Missiomme on rakentaa Suomen paras ja edullisin marketplace. Tarjoamme myyjille alhaisen provision — vain 3% max 35€ per kauppa.',
  ...
  terms: {
    ...
    notice: 'SKRM on alusta yksityishenkilöiden ja yritysten välisille kaupoille. SKRM ei ole osapuoli ostajan ja myyjän välisessä kaupassa.',
