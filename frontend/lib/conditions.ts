...
//
// Puolikunnot (NM+/NM-/EX+/EX-/GD+/GD-) olivat tässä 2026-09-05 - 2026-09-10, mutta omistaja
// ei ollut niitä pyytänyt ja palautti listan takaisin puhtaaseen seitsemän tunnuksen
// Cardmarket-asteikkoon 2026-09-10. Jos joku tuote ehti saada puolikunta-arvon tallennettua
// sinä aikana, arvo jää tietokantaan ennalleen (ei migraatiota) - vain UUSI valinta rajoittuu
// näihin seitsemään.
